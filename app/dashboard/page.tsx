    ...
    <div className='w-full bg-white py-16 px-4'>
      <div className='max-w-[1240px] mx-auto grid md:grid-cols-2'>
        ...
        <div className='flex flex-col justify-center'>
          <p className='text-[#6fc1dd] font-bold '>Dashboard Simples</p>
          ...
          <button className='bg-black text-[#6fc1dd] w-[200px] rounded-md font-medium my-6 mx-auto md:mx-0 py-3'><Link href="/login" className='p-4'>Começar</Link></button>
        </div>
      </div>
    </div>
  );
